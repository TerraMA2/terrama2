...
The computational platform is based on a service-oriented architecture, which is open and provides the technological infrastructure required to b4.1.2 and implement operating systems to monitor early warnings of environmental risks.
...
```
$ git checkout -b b4.1.2 origin/b4.1.2*
```
