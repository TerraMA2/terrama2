...
var StaticHttpRequest = function(params) {
  AbstractRequest.apply(this, arguments);
  this.uri = this.uri.substring(7);
};

StaticHttpRequest.prototype = Object.create(AbstractRequest.prototype);
StaticHttpRequest.prototype.constructor = StaticHttpRequest;

StaticHttpRequest.prototype.request = function() {
  var self = this;
...
StaticHttpRequest.fields = function() {
  var properties = {};
...
module.exports = StaticHttpRequest;