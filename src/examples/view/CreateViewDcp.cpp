...
void addView(terrama2::core::DataManagerPtr dataManager) {
  QString viewJson = R"x({"Views":[{"class":"View","id":14,"name":"view de analise de dcp","description":null,"dataseries_id":23,"dataSeries":{"class":"DataSeries","id":24,"project_id":5,"name":"analise dcp","description":"Generated by analysis analise dcp","data_provider_id":12,"semantics":"ANALYSIS_MONITORED_OBJECT-postgis","active":true,"datasets":[]},"schedule":{},"automatic_schedule":{},"active":true,"service_instance_id":1,"project_id":5,"legend":null,"private":false,"schedule_type":3,"source_type":3}]})x";
