...
int main(int argc, char* argv[])
{
...

  {
    ...
    auto outputDataSeries = terrama2::examples::analysis::utilspostgis::outputDataSeriesPostGis(outputDataProvider, terrama2::examples::analysis::utilspostgis::dcp_result);
