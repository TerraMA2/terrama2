...
int main(int argc, char* argv[])
{
...

  {
    ...
    dataProvider->uri = "file:///home/paulo/Workspace/data/grads/teste/queimadas/output";
    ...
    analysis->script = "return grid.history.interval.sum(\"geotiff\", \"1d\", \"0d\")\n";
...
/*
    ...
    std::string startDate = "2016-01-01 00:00:00";
    ...
    std::string endDate = "2016-01-01 10:00:00";
...
*/
    ...
    //outputGrid->interestAreaBox = terrama2::core::ewktToGeom("SRID=4326;POLYGON((-115 15,-115 30,-100 30,-100 15,-115 15))");
