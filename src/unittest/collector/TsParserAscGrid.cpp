...
#include <terrama2/collector/ParserAscGrid.hpp>
...
void TsParserAscGrid::TestOpenFile()
{
  QString tifFile = terrama2::core::FindInTerraMA2Path("data/asc_grid/20160101000002.gis").c_str();
