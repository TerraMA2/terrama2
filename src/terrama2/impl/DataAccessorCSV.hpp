    ...
    */
    class DataAccessorCSV : public virtual DataAccessorFile
    {
      ...
      protected:
        ...
        void addPropertyByType(std::shared_ptr<te::da::DataSetTypeConverter> converter, size_t i, int type, DataSetPtr dataSet, te::dt::Property* property, QJsonObject fieldObj) const;
