...
bool Reload()
{
  ...
  {
    TERRAMA2_LOG_ERROR() <<  "Error to update data: " << boost::get_error_info< terrama2::ErrorDescription >(e)->toStdString().c_str() << std::endl;
    return false;
  }
  catch(...)
  {
    TERRAMA2_LOG_ERROR() << "Error to update data: Unknow error.";
    return false;
  }
...
{
  TERRAMA2_LOG_ERROR() << "Received shutdown request." << std::endl;
...
int WebService::addDataProvider(DataProvider struct_dataprovider, DataProvider &struct_dataproviderResult)
{
  ...
  {
    TERRAMA2_LOG_ERROR() <<  "Error at add DataProvider: " << boost::get_error_info< terrama2::ErrorDescription >(e)->toStdString().c_str() << std::endl;
...
int WebService::addDataSet(DataSet struct_dataSet, DataSet &struct_datasetResult)
{
  try
  {
    ...
    struct_datasetResult = terrama2::ws::collector::core::DataSet2Struct< DataSet, DataSetItem, Intersection> (dataSet);
  }
  catch(terrama2::Exception &e)
  {
    TERRAMA2_LOG_ERROR() << "Error at add DataSet: " << boost::get_error_info< terrama2::ErrorDescription >(e)->toStdString().c_str() << std::endl;
...
int WebService::updateDataProvider(DataProvider struct_dataprovider, DataProvider &struct_dataproviderResult)
{
  ...
  {
    TERRAMA2_LOG_ERROR() << "Error to update DataProvider: " << boost::get_error_info< terrama2::ErrorDescription >(e)->toStdString().c_str() << std::endl;
...
int WebService::updateDataSet(DataSet struct_dataset, DataSet &struct_datasetResult)
{
  ...
  {
    TERRAMA2_LOG_ERROR() << "Error to update DataSet: " << boost::get_error_info< terrama2::ErrorDescription >(e)->toStdString().c_str() << std::endl;
  ...
  catch(std::exception& e)
  {
    ...
    TERRAMA2_LOG_ERROR() << "Error to update DataSet" << message;
    return soap_receiverfault("Error to update DataSet", message);
  }
...
int WebService::removeDataProvider(uint64_t id)
{
  ...
  {
    TERRAMA2_LOG_ERROR() << "Error to remove DataProvider:" << boost::get_error_info< terrama2::ErrorDescription >(e)->toStdString().c_str() << std::endl;
  ...
  catch(...)
  {
    ...
    return soap_receiverfault("Error to remove DataProvider", message);
  }
...
int WebService::removeDataSet(uint64_t id)
{
  ...
  {
    TERRAMA2_LOG_ERROR() << "Error to remove DataSet: " << boost::get_error_info< terrama2::ErrorDescription >(e)->toStdString().c_str() << std::endl;
  ...
  catch(...)
  {
    const char* message = "Unknown error.";
    TERRAMA2_LOG_ERROR() << message;
    return soap_receiverfault("Error to remove DataSet", message);
  }
...
int WebService::findDataProvider(uint64_t id, DataProvider &struct_dataprovider)
{
  ...
  {
    TERRAMA2_LOG_ERROR() << "Error at find Data Provider: " << boost::get_error_info< terrama2::ErrorDescription >(e)->toStdString().c_str() << std::endl;
  ...
  catch(...)
  {
    const char* message = "Unknown error.";
    TERRAMA2_LOG_ERROR() << message;
    return soap_receiverfault("Error at find Data Provider", message);
  }
...
int WebService::findDataSet(uint64_t id,DataSet &struct_dataset)
{
  try
  {
    ...
    struct_dataset = terrama2::ws::collector::core::DataSet2Struct< DataSet, DataSetItem, Intersection>(dataSet);
  }
  catch(terrama2::Exception &e)
  {
    TERRAMA2_LOG_ERROR() << "Error at find DataSet: " << boost::get_error_info< terrama2::ErrorDescription >(e)->toStdString().c_str() << std::endl;
  ...
  catch(...)
  {
    const char* message = "Unknown error.";
    TERRAMA2_LOG_ERROR() << message;
    return soap_receiverfault("Error at find DataSet", message);
  }
...
int WebService::listDataProvider(std::vector< DataProvider > &data_provider_list)
{
  ...
  {
    TERRAMA2_LOG_ERROR() << "Error at list Data Providers: " << boost::get_error_info< terrama2::ErrorDescription >(e)->toStdString().c_str() << std::endl;
  ...
  catch(...)
  {
    const char* message = "Unknown error.";
    TERRAMA2_LOG_ERROR() << message;
    return soap_receiverfault("Error at list Data Providers", message);
  }
  return SOAP_OK;
}
...
int WebService::listDataSet(std::vector< DataSet > &data_set_list)
{
  try
  {
    ...
    {
      data_set_list.push_back(terrama2::ws::collector::core::DataSet2Struct< DataSet, DataSetItem, Intersection>(datasets.at(i)));
    }
  }
  catch(terrama2::Exception &e)
  {
    TERRAMA2_LOG_ERROR() << "Error at list DataSets: " << boost::get_error_info< terrama2::ErrorDescription >(e)->toStdString().c_str() << std::endl;
  ...
  catch(...)
  {
    const char* message = "Unknown error.";
    TERRAMA2_LOG_ERROR() << message;
    return soap_receiverfault("Error at list DataSet", message);
  }
