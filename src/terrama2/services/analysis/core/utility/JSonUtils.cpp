...
terrama2::services::analysis::core::AnalysisPtr terrama2::services::analysis::core::fromAnalysisJson(const QJsonObject& json)
{
  ...
  if(!(json.contains("id")
       ...
       && json.contains("output_data_series_id")
  ...
  analysis->outputDataSeriesId = json["output_data_series_id"].toInt();
...
QJsonObject terrama2::services::analysis::core::toJson(AnalysisPtr analysis)
{
  ...
  obj.insert("output_data_series_id", static_cast<qint32>(analysis->outputDataSeriesId));
