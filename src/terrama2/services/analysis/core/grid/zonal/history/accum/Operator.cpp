...
std::unordered_map<std::pair<int, int>, std::pair<double, int>, terrama2::services::analysis::core::grid::zonal::history::accum::PairHash>
                                                                        ...
                                                                        OperatorCache cache)
{
  ...
  std::unordered_map<std::pair<int, int>, std::pair<double, int>, terrama2::services::analysis::core::grid::zonal::history::accum::PairHash> valuesMap;
