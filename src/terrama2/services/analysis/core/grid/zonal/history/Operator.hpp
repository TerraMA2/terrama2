...
#ifndef __TERRAMA2_SERVINCES_ANALYSIS_CORE_GRID_ZONAL_HISTORY_OPERATOR_HPP__
#define __TERRAMA2_SERVINCES_ANALYSIS_CORE_GRID_ZONAL_HISTORY_OPERATOR_HPP__
        ...
        namespace grid
        {
          namespace zonal
          {
            namespace history
            {
              ...
              std::vector<std::string> list(const std::string& dataSeriesName, const std::string& dateDiscardBefore, terrama2::services::analysis::core::Buffer buffer = Buffer());
...
#endif // __TERRAMA2_SERVINCES_ANALYSIS_CORE_GRID_ZONAL_HISTORY_OPERATOR_HPP__
