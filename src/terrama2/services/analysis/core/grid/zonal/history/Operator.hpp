        ...
        namespace grid
        {
          namespace zonal
          {
            namespace history
            {
              ...
              */
              TMANALYSISEXPORT int numImpl(const std::string& dataSeriesName, const std::string& dateDiscardBefore, const std::string& dateDiscardAfter, terrama2::services::analysis::core::Buffer buffer = Buffer());

              TMANALYSISEXPORT int num(const std::string& dataSeriesName, const std::string& dateDiscardBefore, terrama2::services::analysis::core::Buffer buffer = Buffer());

              /*!
                \brief Return the list of timestamps of the raster images available for the area and time constrains.
              */
              TMANALYSISEXPORT boost::python::list listImpl(const std::string& dataSeriesName, const std::string& dateDiscardBefore, const std::string& dateDiscardAfter, terrama2::services::analysis::core::Buffer buffer = Buffer());

              TMANALYSISEXPORT boost::python::list list(const std::string& dataSeriesName, const std::string& dateDiscardBefore, terrama2::services::analysis::core::Buffer buffer = Buffer());
