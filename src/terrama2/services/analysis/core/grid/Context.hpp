...
/*!
  \file terrama2/services/analysis/core/grid/GridContext.hpp
    ...
    namespace analysis
    {
      namespace core
      {
        namespace grid
        {
          ...
          {
            public:
              Context(DataManagerPtr dataManager,  AnalysisPtr analysis, std::shared_ptr<te::dt::TimeInstantTZ> startTime);
