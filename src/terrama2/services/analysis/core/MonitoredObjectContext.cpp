...
// BOOST_PYTHON_FUNCTION_OVERLOADS(occurrenceCount_overloads, terrama2::services::analysis::core::occurrence::count, 4, 5);

// struct occurrenceCount_overloads : public ::boost::python::detail::overloads_common<occurrenceCount_overloads>
// {
//   struct non_void_return_type
//   {
//     static const int n_funcs = 2;
//     static const int max_args = n_funcs;
//     template <typename SigT> struct gen
//     {
...
//       typedef typename ::boost::mpl::next<iter0>::type iter1;
//       typedef typename ::boost::mpl::deref<iter0>::type T0;
//       typedef typename ::boost::mpl::next<iter1>::type iter2;
//       typedef typename ::boost::mpl::deref<iter1>::type T1;
//       typedef typename ::boost::mpl::next<iter2>::type iter3;
//       typedef typename ::boost::mpl::deref<iter2>::type T2;
//       typedef typename ::boost::mpl::next<iter3>::type iter4;
//       typedef typename ::boost::mpl::deref<iter3>::type T3;
//       typedef typename ::boost::mpl::next<iter4>::type iter5;
//       typedef typename ::boost::mpl::deref<iter4>::type T4;
//       static RT func_0(T0 arg0 , T1 arg1 , T2 arg2 , T3 arg3)
//       {
//         return terrama2::services::analysis::core::occurrence::count(arg0 , arg1 , arg2 , arg3);
//       }
//       static RT func_1(T0 arg0 , T1 arg1 , T2 arg2 , T3 arg3 , T4 arg4)
//       {
//         return terrama2::services::analysis::core::occurrence::count(arg0 , arg1 , arg2 , arg3 , arg4);
//       }
//     };
//   };
//
//   typedef non_void_return_type void_return_type;
//   occurrenceCount_overloads(char const* doc = 0) : ::boost::python::detail::overloads_common<occurrenceCount_overloads>(doc) {}
//
//   template <std::size_t N> occurrenceCount_overloads(char const* doc, ::boost::python::detail::keywords<N> const& keywords) : ::boost::python::detail::overloads_common<occurrenceCount_overloads>(doc, keywords.range())
//   {
//     typedef typename ::boost::python::detail:: error::more_keywords_than_function_arguments< N,5>::too_many_keywords assertion;
//   }
//
//   template <std::size_t N> occurrenceCount_overloads(::boost::python::detail::keywords<N> const& keywords, char const* doc = 0) : ::boost::python::detail::overloads_common<occurrenceCount_overloads>(doc, keywords.range())
//   {
//     typedef typename ::boost::python::detail:: error::more_keywords_than_function_arguments< N,5>::too_many_keywords assertion;
//   }
// };
...
//
// BOOST_PYTHON_FUNCTION_OVERLOADS(occurrenceMin_overloads, terrama2::services::analysis::core::occurrence::min, 5, 6);
//
// BOOST_PYTHON_FUNCTION_OVERLOADS(occurrenceMax_overloads, terrama2::services::analysis::core::occurrence::max, 5, 6);
//
// BOOST_PYTHON_FUNCTION_OVERLOADS(occurrenceMean_overloads, terrama2::services::analysis::core::occurrence::mean, 5, 6);
//
// BOOST_PYTHON_FUNCTION_OVERLOADS(occurrenceMedian_overloads, terrama2::services::analysis::core::occurrence::median, 5, 6);
//
// BOOST_PYTHON_FUNCTION_OVERLOADS(occurrenceSum_overloads, terrama2::services::analysis::core::occurrence::sum, 5, 6);
//
// BOOST_PYTHON_FUNCTION_OVERLOADS(occurrenceStandardDeviation_overloads, terrama2::services::analysis::core::occurrence::standardDeviation, 5, 6);
//
// BOOST_PYTHON_FUNCTION_OVERLOADS(occurrenceAggregationCount_overloads, terrama2::services::analysis::core::occurrence::aggregation::count, 5, 6);
//
// BOOST_PYTHON_FUNCTION_OVERLOADS(occurrenceAggregationMin_overloads, terrama2::services::analysis::core::occurrence::aggregation::min, 7, 8);
//
// BOOST_PYTHON_FUNCTION_OVERLOADS(occurrenceAggregationMax_overloads, terrama2::services::analysis::core::occurrence::aggregation::max, 7, 8);
//
// BOOST_PYTHON_FUNCTION_OVERLOADS(occurrenceAggregationMean_overloads, terrama2::services::analysis::core::occurrence::aggregation::mean, 7, 8);
//
// BOOST_PYTHON_FUNCTION_OVERLOADS(occurrenceAggregationMedian_overloads, terrama2::services::analysis::core::occurrence::aggregation::median, 7, 8);
//
// BOOST_PYTHON_FUNCTION_OVERLOADS(occurrenceAggregationSum_overloads, terrama2::services::analysis::core::occurrence::aggregation::sum, 7, 8);
//
// BOOST_PYTHON_FUNCTION_OVERLOADS(occurrenceAggregationStandardDeviation_overloads, terrama2::services::analysis::core::occurrence::aggregation::standardDeviation, 7, 8);
...
void terrama2::services::analysis::core::MonitoredObjectContext::registerOccurrenceFunctions()
{
  ...
  boost::python::object occurenceModule(handle<>(borrowed(PyImport_AddModule("terrama2.occurence"))));
  // make "from terrama2 import occurence" work
  import("terrama2").attr("occurence") = occurenceModule;
  // set the current scope to the new sub-module
  scope occurrenceScope = occurenceModule;

  auto context = std::static_pointer_cast<MonitoredObjectContext>(shared_from_this());

  // export functions inside occurrence namespace
  def("count", boost::python::make_function(boost::bind(&terrama2::services::analysis::core::occurrence::count,
      context,
      boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3,
      boost::placeholders::_4),
      default_call_policies(),
      boost::mpl::vector<int, const std::string&, terrama2::services::analysis::core::Buffer,const std::string&, const std::string&>()));
  // occurrenceCount_overloads(args("dataSeriesName", "buffer", "dateFilter", "restriction"),
                              // "Count operator for occurrence"));
                              //
                              // def("min", boost::python::make_function(boost::bind(&terrama2::services::analysis::core::occurrence::min,
                              //                                                     context,
                              //                                                     boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3,
                              //                                                     boost::placeholders::_4, boost::placeholders::_5),
                              //     default_call_policies(),
                              //     boost::mpl::vector<double, const std::string&, terrama2::services::analysis::core::Buffer,const std::string&, const std::string&, const std::string&>()),
                              //     occurrenceMin_overloads(args("dataSeriesName", "buffer", "dateFilter", "attribute", "restriction"), "Minimum operator for occurrence"));
                              //
                              // def("max", boost::python::make_function(boost::bind(&terrama2::services::analysis::core::occurrence::max,
                              //                                                     context,
                              //                                                     boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3,
                              //                                                     boost::placeholders::_4, boost::placeholders::_5),
                              //     default_call_policies(),
                              ...
                              //
                              // def("mean", boost::python::make_function(boost::bind(&terrama2::services::analysis::core::occurrence::mean,
                              //                                                     context,
                              //                                                     boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3,
                              //                                                     boost::placeholders::_4, boost::placeholders::_5),
                              //     default_call_policies(),
                              ...
                              //
                              // def("median", boost::python::make_function(boost::bind(&terrama2::services::analysis::core::occurrence::median,
                              //                                                     context,
                              //                                                     boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3,
                              //                                                     boost::placeholders::_4, boost::placeholders::_5),
                              //     default_call_policies(),
                              ...
                              //
                              // def("sum", boost::python::make_function(boost::bind(&terrama2::services::analysis::core::occurrence::sum,
                              //                                                     context,
                              //                                                     boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3,
                              //                                                     boost::placeholders::_4, boost::placeholders::_5),
                              //     default_call_policies(),
                              ...
                              //
                              // def("standard_deviation", boost::python::make_function(boost::bind(&terrama2::services::analysis::core::occurrence::standardDeviation,
                              //                                                     context,
                              //                                                     boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3,
                              //                                                     boost::placeholders::_4, boost::placeholders::_5),
                              //     default_call_policies(),
                              ...
                              // def("count", boost::python::make_function(boost::bind(&terrama2::services::analysis::core::occurrence::aggregation::count,
                              //                                                     context,
                              //                                                     boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3,
                              //                                                     boost::placeholders::_4, boost::placeholders::_5),
                              //     default_call_policies(),
                              //     boost::mpl::vector<int, const std::string&, terrama2::services::analysis::core::Buffer,const std::string&, terrama2::services::analysis::core::Buffer, const std::string&>()),
                              ...
                              //
                              // def("min", boost::python::make_function(boost::bind(&terrama2::services::analysis::core::occurrence::aggregation::min,
                              //                                                     context,
                              //                                                     boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3,
                              //                                                     boost::placeholders::_4, boost::placeholders::_5, boost::placeholders::_6, boost::placeholders::_7),
                              //     default_call_policies(),
                              //     boost::mpl::vector<double, const std::string&, terrama2::services::analysis::core::Buffer,const std::string&, const std::string&, terrama2::services::analysis::core::StatisticOperation, terrama2::services::analysis::core::Buffer, const std::string&>()),
                              ...
                              //
                              // def("max", boost::python::make_function(boost::bind(&terrama2::services::analysis::core::occurrence::aggregation::max, context, boost::placeholders::_1, boost::placeholders::_2,boost::placeholders::_3,boost::placeholders::_4),
                              //     default_call_policies(),
                              //     boost::mpl::vector<double, const std::string&, terrama2::services::analysis::core::Buffer,const std::string&, const std::string&>()),
                              ...
                              //
                              // def("mean", boost::python::make_function(boost::bind(&terrama2::services::analysis::core::occurrence::aggregation::mean, context, boost::placeholders::_1, boost::placeholders::_2,boost::placeholders::_3,boost::placeholders::_4),
                              //     default_call_policies(),
                              //     boost::mpl::vector<double, const std::string&, terrama2::services::analysis::core::Buffer,const std::string&, const std::string&>()),
                              ...
                              //
                              // def("median", boost::python::make_function(boost::bind(&terrama2::services::analysis::core::occurrence::aggregation::median, context, boost::placeholders::_1, boost::placeholders::_2,boost::placeholders::_3,boost::placeholders::_4),
                              //     default_call_policies(),
                              //     boost::mpl::vector<double, const std::string&, terrama2::services::analysis::core::Buffer,const std::string&, const std::string&>()),
                              //     occurrenceAggregationMedian_overloads(args("dataSeriesName", "buffer", "dateFilter", "aggregationBuffer", "restriction"), "Median operator for occurrence aggregation"));
                                //
                                // def("sum", boost::python::make_function(boost::bind(&terrama2::services::analysis::core::occurrence::aggregation::sum, context, boost::placeholders::_1, boost::placeholders::_2,boost::placeholders::_3,boost::placeholders::_4),
                                //     default_call_policies(),
                                //     boost::mpl::vector<double, const std::string&, terrama2::services::analysis::core::Buffer,const std::string&, const std::string&>()),
                                //     occurrenceAggregationSum_overloads(args("dataSeriesName", "buffer", "dateFilter", "aggregationBuffer", "restriction"), "Sum operator for occurrence aggregation"));
                                  //
                                  // def("standard_deviation", boost::python::make_function(boost::bind(&terrama2::services::analysis::core::occurrence::aggregation::standardDeviation, context, boost::placeholders::_1, boost::placeholders::_2,boost::placeholders::_3,boost::placeholders::_4),
                                  //     default_call_policies(),
                                  //     boost::mpl::vector<double, const std::string&, terrama2::services::analysis::core::Buffer,const std::string&, const std::string&>()),
