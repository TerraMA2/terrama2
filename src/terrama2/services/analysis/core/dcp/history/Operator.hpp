...
#ifndef __TERRAMA2_ANALYSIS_CORE_DCP_ZONAL_HISTORY_OPERATOR_HPP__
#define __TERRAMA2_ANALYSIS_CORE_DCP_ZONAL_HISTORY_OPERATOR_HPP__
        ...
        namespace dcp
        {
          ...
          */
            TMANALYSISEXPORT double sum(const std::string& attribute,
                       const std::string& dateFilter, boost::python::list ids = boost::python::list());
...
#endif //__TERRAMA2_ANALYSIS_CORE_DCP_ZONAL_HISTORY_OPERATOR_HPP__
