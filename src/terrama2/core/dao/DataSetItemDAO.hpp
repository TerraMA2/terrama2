...
#ifndef __TERRAMA2_CORE_DAO_DATASETITEMDAO_HPP__
#define __TERRAMA2_CORE_DAO_DATASETITEMDAO_HPP__
     ...
     namespace dao
     {
      ...
      class DataSetItemDAO
      {
        ...
        private:
          ...
          /*!
            \brief Insert the given DataSetItem metadata in the database.
            ...
            \exception terrama2::Exception If the operation doesn't succeed it will raise an exception.
           */
          static void saveMetadata(uint64_t datasetItemId,
                                          const std::map<std::string, std::string>& metadata,
                                          te::da::DataSourceTransactor& transactor);

          /*!
            \brief Update the DataSetItem metadata information in the database.

            \param datasetItemId  The identifier of the dataset item.
            \param metadata       The DataSetItem metadata to be updated into the database.
            \param transactor     The data source transactor to be used to perform the update operation.
            ...
            \exception terrama2::Exception If the operation doesn't succeed it will raise an exception.
           */
          static void updateMetadata(uint64_t datasetItemId,
                                            std::map<std::string, std::string>& metadata,
                                            te::da::DataSourceTransactor& transactor);

          /*!
            \brief Removes the DataSetItem metadata information from the database.
            ...
            \exception terrama2::Exception If the operation doesn't succeed it will raise an exception.
           */
          static void removeMetadata(uint64_t datasetItemId, te::da::DataSourceTransactor& transactor);

          /*!
            \brief Load the metadata of the informed dataset item.
            ...
            \exception terrama2::Exception If the operation doesn't succeed it will raise an exception.
           */
          static void loadMetadata(DataSetItem& item, te::da::DataSourceTransactor& transactor);
...
#endif // __TERRAMA2_CORE_DAO_DATASETITEMDAO_HPP__
