...
// {
//   std::map<DataProviderId, DataProvider> providers; //!< A map from data-provider-id to data-provider.
//   std::map<DataSeriesId, DataSeries> dataseries;       //!< A map from data-set-id to dataseries.
