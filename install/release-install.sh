...
if ! [ test -f "TerraMA2-4.1.1-beta-release-linux-x64-Ubuntu-16.04.deb" ]
then
    wget -q http://www.dpi.inpe.br/jenkins-data/terrama2/installers/linux/final/TerraMA2-4.1.1-beta-release-linux-x64-Ubuntu-16.04.deb
fi

sudo dpkg -i TerraMA2-4.1.1-beta-release-linux-x64-Ubuntu-16.04.deb

if ! [ test -f "terrama2-doc-4.1.1-beta.deb" ]
then
    wget -q http://www.dpi.inpe.br/jenkins-data/terrama2/installers/linux/final/terrama2-doc-4.1.1-beta.deb
fi

sudo dpkg -i terrama2-doc-4.1.1-beta.deb