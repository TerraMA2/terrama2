...
mkdir terrama2-deb
cd terrama2-deb
if [ ! -f "TerraMA2-4.1.2-dev-linux-x64-Ubuntu-16.04.deb" ]
then
    wget -q http://www.dpi.inpe.br/jenkins-data/terrama2/installers/linux/final/TerraMA2-4.1.2-dev-linux-x64-Ubuntu-16.04.deb
fi

sudo dpkg -i TerraMA2-4.1.2-dev-linux-x64-Ubuntu-16.04.deb

sudo apt install -y -f

if [ ! -f "terrama2-doc-4.1.2-dev.deb" ]
then
    wget -q http://www.dpi.inpe.br/jenkins-data/terrama2/installers/linux/final/terrama2-doc-4.1.2-dev.deb
fi

sudo dpkg -i terrama2-doc-4.1.2-dev.deb
