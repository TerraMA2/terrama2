...
if ! [ test -f "TerraMA2-4.1.1-beta-linux-x64-Ubuntu-16.04.deb" ]
then
    wget -q http://www.dpi.inpe.br/jenkins-data/terrama2/installers/linux/final/TerraMA2-4.1.1-beta-linux-x64-Ubuntu-16.04.deb
fi
