...
define(
  ...
  function(TerraMA2WebComponents) {
    ...
    var addLayerToSort = function(layerId, layerName, parent) {
      ...
      var spanIcon = "<span class='terrama2-layer-tools terrama2-datepicker-icon' data-toggle='tooltip' title='Layer Tools'>" + (parent != 'custom' && parent != 'template' ? " <i class='fa fa-arrows-h'></i>" : "") + " <i class='fa fa-gear'></i></span>";
